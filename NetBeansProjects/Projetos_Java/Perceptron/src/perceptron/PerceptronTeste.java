...
public class PerceptronTeste {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Entrada: 0, Entrada 0 = SaÃ­da " + or.calculaResultado(new int[]{0, 0}));
        System.out.println("Entrada: 0, Entrada 1 = SaÃ­da " + or.calculaResultado(new int[]{0, 1}));
        System.out.println("Entrada: 1, Entrada 0 = SaÃ­da " + or.calculaResultado(new int[]{1, 0}));
        System.out.println("Entrada: 1, Entrada 1 = SaÃ­da " + or.calculaResultado(new int[]{1, 1}));
        ...
        System.out.println("Entrada: 0, Entrada 0 = SaÃ­da " + xor.calculaResultado(new int[]{0, 0}));
        System.out.println("Entrada: 0, Entrada 1 = SaÃ­da " + xor.calculaResultado(new int[]{0, 1}));
        System.out.println("Entrada: 1, Entrada 0 = SaÃ­da " + xor.calculaResultado(new int[]{1, 0}));
        System.out.println("Entrada: 1, Entrada 1 = SaÃ­da " + xor.calculaResultado(new int[]{1, 1}));
